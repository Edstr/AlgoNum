...
{
    //Pas de duplication du code ! Plus facile à maintenir
...
void GeomGlut::setCouleur( GLfloat r, GLfloat g, GLfloat b )
{
    glColor3f(r, g, b);
}

void GeomGlut::texte(float x, float y, void *font, const char *texte)
{
    const char *c;
    glRasterPos2f(x, y);
    for (c=texte; *c != '\0'; c++) {
